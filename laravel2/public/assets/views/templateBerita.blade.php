         ...
         <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <ul class="contact-details float-left">
                           <li><i class="fa fa-map-marker"></i>Tropis Animal Street 125 - Melbourne</li>
                           <li><i class="fa fa-envelope"></i><a href="mailto:email@site.com">tropisanimal@yoursite.com</a></li>
            ...
            <div class="navbar container-fluid">
               <div class="container ">
                  ...
                  <i class="flaticon-dog-20"></i><span>Animal!</span>
                  </a>
                  <!-- Navbartoggler -->
